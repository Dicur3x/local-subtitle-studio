...
FFmpeg follows the provider's current stable release. whisper.cpp ignores build-number tags, drafts, and prereleases and selects the newest stable semantic release containing the required Windows asset.
